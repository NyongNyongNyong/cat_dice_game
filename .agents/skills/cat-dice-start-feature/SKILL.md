...
description: Use when the user asks /start-feature, start feature, create feature branch, or begin new work in the Cat Tower Casino Godot project. Create a feature/* branch from latest main with tools/start-feature.sh and declare the expected scenes/scripts scope before implementation.
---
...
5. Infer the likely `scenes/`·`scripts/` paths this slug should touch in one or two short sentences. Do not ask the user to write the path list.
