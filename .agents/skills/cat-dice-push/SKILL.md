---
name: cat-dice-push
description: Use when the user asks /push, push, finish this feature, commit and merge, or complete a feature branch in the Cat Tower Casino Godot project. Finish a feature/* branch by inspecting scope, generating a commit message, running tools/push-feature.sh, and stopping safely if origin/main changed.
---
...
2. If the current branch is not `feature/*`, stop and guide the user to start a feature branch with `tools/start-feature.sh`.
